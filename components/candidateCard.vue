<script setup lang="ts">
    ...
    <template>
      <div class="card-candidate" v-for="user in users" :key="user.id">
        ...
        <div class="card-candidate-right">
          <div class="card-candidate-information">
            <div class="card-candidate-information-name-cross">
              <div class="subsubTitle">{{ user.name }}</div>
              <div
            ...
            <div class="text">{{ user.degree }}</div>
            <a href="mailto: {{user.email}}" class="text send-email-candidate">{{
              user.mail
            }}</a>
          </div>
